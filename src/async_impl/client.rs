...
struct Config {
    ...
    tls_info: bool,
    #[cfg(feature = "__tls")]
    tls_keying_material_specs: Vec<crate::tls_keying_material::KeyingMaterialSpec>,
    #[cfg(feature = "__tls")]
    tls: TlsBackend,
    ...
    pub fn new() -> Self {
        ...
        ClientBuilder {
            config: Config {
                ...
                tls_info: false,
                #[cfg(feature = "__tls")]
                tls_keying_material_specs: Vec::new(),
                #[cfg(feature = "__tls")]
...
impl ClientBuilder {
    ...
    pub fn build(self) -> crate::Result<Client> {
        ...
        let keying_material_specs: Arc<[crate::tls_keying_material::KeyingMaterialSpec]> =
            Arc::from(config.tls_keying_material_specs.clone());
    ...
    pub fn tls_export_keying_material(
        ...
        if let Some(existing) = self
            .config
            .tls_keying_material_specs
            .iter_mut()
            .find(|s| s.label == spec.label && s.context == spec.context)
        {
            *existing = spec;
        } else {
            self.config.tls_keying_material_specs.push(spec);
        }
        self
    }
    ...
    pub(crate) fn peek_tls_keying_material_specs_for_test(
        ...
        &self.config.tls_keying_material_specs
    }
...
impl Config {
    fn fmt_fields(&self, f: &mut fmt::DebugStruct<'_, '_>) {
        ...
        #[cfg(feature = "__tls")]
        {
            ...
            f.field(
                "tls_keying_material_specs",
                &self.tls_keying_material_specs.len(),
            );
        }
